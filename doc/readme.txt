Телефоний довідник  (phones)
Версия: 1
Дата: 01.05.2022
Автор: ЮСА

Додаток призначений для відображення інформації щодо телефонів, посад , відділів, географічної адреси, та адреси електроної пошти співробітників, і розрахований на використання в локальній мережі організації. 
...
-- [quotes.csv] - підборка цитат для завантаження в базу даних
-- [phones_export.csv] - експортована версґЯ бази даних (при виконаннґ експорту)
-- [quotes_export.csv] - експортована пґдборка цитат з бази даних (при виконаннґ експорту)

каталог [phones] - файли (скріпти), для розміщення на веб-сервері.
